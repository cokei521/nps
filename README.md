...
> 在 [GitHub](https://github.com/djylb/nps) 点击右上角 ⭐ Star 以支持原开发者[djylb/nps](https://github.com/djylb/nps)在空闲时间继续开发
...
### 由于[NPS](https://github.com/ehang-io/nps)停更已久,本仓库由[djylb/nps](https://github.com/djylb/nps)更新二次开发而来
...
更多详细配置请参考 [文档](https://docs.081011.xyz/)（部分内容可能未更新）。
